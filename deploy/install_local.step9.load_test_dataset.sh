...
nohup python3 gcloud_dataproc/submit.py --cpu-limit $PIPELINE_CPU_LIMIT --num-executors $PIPELINE_CPU_LIMIT  --run-locally hail_scripts/v01/load_dataset_to_es.py \
